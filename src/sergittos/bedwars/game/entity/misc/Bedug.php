...
class Bedug extends Living
{
    ...
    public function initEntity(CompoundTag $nbt): void{
        ...
        $this->owner = $this->getOwningEntity();
    ...
    public function checkEntity(Living $entity): void{
        if($entity instanceof Player){
            ...
            if($this->getLocation()->distance($entity->getPosition()) > self::TARGET_MAX_DISTANCE){
                $this->target = null;
            }
        }
    }
    ...
    private function updateTarget(): void{
        ...
        if(!$this->target instanceof Player || !$this->target->isAlive() || $this->target->isClosed()){
            foreach($this->getWorld()->getEntities() as $entity){
                ...
                if($this->getPosition()->distanceSquared($entity->getPosition()) > self::TARGET_MAX_DISTANCE){
                    continue;
                }
                if($entity instanceof Player){
